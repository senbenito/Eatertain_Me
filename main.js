$(document).ready(function() {
  var results = [];
    ...
    $('#searchButton').on('click', function() {
        ...
        //AJAX call request here:
        // var $xhr = $.ajax({
        //     url: `https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?addRecipeInformation=true&cuisine=${cuisine}&limitLicense=false&number=3&offset=0&query=${query}&ranking=1&type=main+course`, // The URL to the API. You can get this by clicking on "Show CURL example" from an API profile
